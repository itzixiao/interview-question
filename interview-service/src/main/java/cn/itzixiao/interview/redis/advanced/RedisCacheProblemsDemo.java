 ...
 * └─────────────────────────────────────────────────────────────────────────┘
 */
public class RedisCacheProblemsDemo {

    // 模拟 Redis 缓存
    private static final ConcurrentHashMap<String, Object> cache = new ConcurrentHashMap<>();
    // 模拟数据库
    private static final ConcurrentHashMap<String, Object> database = new ConcurrentHashMap<>();
    // 布隆过滤器（简化版）
    ...
    public static void main(String[] args) throws Exception {
        ...
        RedisCacheProblemsDemo demo = new RedisCacheProblemsDemo();
    ...
    private void demonstrateCacheConsistency() {
        ...
        System.out.println("┌─────────────┬─────────────────────────────┬─────────────────────────────┐");
        System.out.println("│  Cache Aside│  先更新数据库，再删除缓存    │  读：先读缓存，miss则读库    │");
        System.out.println("│  (旁路缓存) │  （推荐）                    │      再写缓存               │");
        System.out.println("│             │                              │  写：先写库，再删缓存        │");
        System.out.println("├─────────────┼─────────────────────────────┼─────────────────────────────┤");
        System.out.println("│  Read/Write │  先更新缓存，再异步写数据库  │  数据一致性好               │");
        System.out.println("│  Through    │                              │  实现复杂                   │");
        System.out.println("├─────────────┼─────────────────────────────┼─────────────────────────────┤");
        System.out.println("│  Write      │  只更新缓存，异步写数据库    │  性能最好                   │");
        System.out.println("│  Behind     │                              │  可能丢数据                 │");
        System.out.println("└─────────────┴─────────────────────────────┴─────────────────────────────┘\n");
    ...
    private int getRandomExpireTime(int baseSeconds) {
        return baseSeconds + (int) (Math.random() * 300);
    }
}
