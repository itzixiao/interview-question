...
- [四、sleep() vs wait() 深度对比](#四-sleep-vs-wait-深度对比)
- [五、死锁详解](#五死锁详解)
- [六、高频面试题](#六高频面试题)
...
完整可运行代码请参见：`interview-microservices-parent/interview-service/src/main/java/cn/itzixiao/interview/concurrency/ThreadBasicsDemo.java`
