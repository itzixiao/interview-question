...
> **一站式 Java 面试准备平台** - 80 篇文档 · 711+ 道面试题 · 配套 ~42,000 行示例代码
...
| 🔹 **11-中间件**             | 16 篇 | 146+ 道 | [详细文档](./docs/11-中间件/README.md)             |
...
| 🔹 **19-网络安全等级保护**       | 3 篇  | 23+ 道  | [详细文档](./docs/19-网络安全等级保护/README.md)       |
| 🔹 **20-AI视频生成**          | 1 篇  | 5+ 道   | [详细文档](./docs/20-AI视频生成/README.md)          |

**总计：** 80 篇文档 · 711+ 道面试题 · 配套 ~42,000 行示例代码
...
- [Dubbo 核心架构与调用流程？](./docs/11-中间件/16-Dubbo%20RPC框架详解.md)
- [Dubbo SPI 与 JDK SPI 区别？](./docs/11-中间件/16-Dubbo%20RPC框架详解.md)
- [Dubbo 负载均衡与集群容错？](./docs/11-中间件/16-Dubbo%20RPC框架详解.md)
...
- [📘 11-中间件](./docs/11-中间件/README.md) - 15 篇文档，128+ 道面试题
...
- [📘 19-网络安全等级保护](./docs/19-网络安全等级保护/README.md) - 3 篇文档，23+ 道面试题 ⭐新增
- [📘 20-AI视频生成](./docs/20-AI视频生成/README.md) - 1 篇文档，5+ 道知识题 ⭐新增
