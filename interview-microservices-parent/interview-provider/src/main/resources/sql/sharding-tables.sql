...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='设备运行日志表（逻辑表）';
...
CREATE TABLE IF NOT EXISTS `device_operation_log_202601` (
    ...
    INDEX `idx_operation_time` (`operation_time`) USING BTREE,
    INDEX `idx_device_code` (`device_code`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='设备运行日志表 - 2026 年 1 月';
...
CREATE TABLE IF NOT EXISTS `device_operation_log_202602` (
    ...
    INDEX `idx_operation_time` (`operation_time`) USING BTREE,
    INDEX `idx_device_code` (`device_code`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='设备运行日志表 - 2026 年 2 月';
...
CREATE TABLE IF NOT EXISTS `device_operation_log_202603` (
    ...
    INDEX `idx_operation_time` (`operation_time`) USING BTREE,
    INDEX `idx_device_code` (`device_code`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='设备运行日志表 - 2026 年 3 月';
...
CREATE TABLE IF NOT EXISTS `device_operation_log_202604` (
    ...
    INDEX `idx_operation_time` (`operation_time`) USING BTREE,
    INDEX `idx_device_code` (`device_code`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='设备运行日志表 - 2026 年 4 月';
...
CREATE TABLE IF NOT EXISTS `device_operation_log_202605` (
    ...
    INDEX `idx_operation_time` (`operation_time`) USING BTREE,
    INDEX `idx_device_code` (`device_code`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='设备运行日志表 - 2026 年 5 月';
...
CREATE TABLE IF NOT EXISTS `device_operation_log_202606` (
    ...
    INDEX `idx_operation_time` (`operation_time`) USING BTREE,
    INDEX `idx_device_code` (`device_code`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='设备运行日志表 - 2026 年 6 月';
...
CREATE TABLE IF NOT EXISTS `device_operation_log_202607` (
    ...
    INDEX `idx_operation_time` (`operation_time`) USING BTREE,
    INDEX `idx_device_code` (`device_code`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='设备运行日志表 - 2026 年 7 月';
...
CREATE TABLE IF NOT EXISTS `device_operation_log_202608` (
    ...
    INDEX `idx_operation_time` (`operation_time`) USING BTREE,
    INDEX `idx_device_code` (`device_code`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='设备运行日志表 - 2026 年 8 月';
...
CREATE TABLE IF NOT EXISTS `device_operation_log_202609` (
    ...
    INDEX `idx_operation_time` (`operation_time`) USING BTREE,
    INDEX `idx_device_code` (`device_code`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='设备运行日志表 - 2026 年 9 月';
...
CREATE TABLE IF NOT EXISTS `device_operation_log_202610` (
    ...
    INDEX `idx_operation_time` (`operation_time`) USING BTREE,
    INDEX `idx_device_code` (`device_code`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='设备运行日志表 - 2026 年 10 月';
...
CREATE TABLE IF NOT EXISTS `device_operation_log_202611` (
    ...
    INDEX `idx_operation_time` (`operation_time`) USING BTREE,
    INDEX `idx_device_code` (`device_code`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='设备运行日志表 - 2026 年 11 月';
...
CREATE TABLE IF NOT EXISTS `device_operation_log_202612` (
    ...
    INDEX `idx_operation_time` (`operation_time`) USING BTREE,
    INDEX `idx_device_code` (`device_code`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='设备运行日志表 - 2026 年 12 月';
